#ifndef STREAMCLASSIFIER_COUNT_HEAP_H
#define STREAMCLASSIFIER_COUNT_HEAP_H
...
template<uint8_t key_len, int capacity, int d>
struct CountHeap {
public:
...
//public:
    CountHeap(int cm_memory_in_bytes) : heap_element_num(0), w(cm_memory_in_bytes / 4 / d) {
