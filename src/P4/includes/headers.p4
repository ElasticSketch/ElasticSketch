...
// for telemetry watchlist, avoid additional metadata to unify udp and tcp ports
...
// for telemetry report triggering, parsed after inner_l4_ports
...
header_type telemetry_report_header_t {
    fields {
        version             : 4;
        next_proto          : 4;
        dropped             : 1;
